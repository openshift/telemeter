...
require (
	...
	github.com/observatorium/up v0.0.0-20240109123005-e1e1857b0b6e
...
require (
	...
	github.com/thanos-io/promql-engine v0.0.0-20231214130043-41b2cf818e81 // indirect
	...
	go.opentelemetry.io/contrib/samplers/jaegerremote v0.7.0 // indirect
...
replace (
	...
	// Temporary replace until Thanos catches up with > v0.48.1.
	github.com/prometheus/prometheus => github.com/prometheus/prometheus v0.48.1-0.20231212213830-d0c2d9c0b9cc
